...
public Window(JTextArea txtara) {
    this(txtara,1000);
    }

public Window(JTextArea txtara, int maxlin) {
    if(maxlin<1) { throw new IllegalArgumentException("Window maximum lines must be positive (value="+maxlin+")"); }
    oneByte=new byte[1];

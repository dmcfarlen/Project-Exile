	...
	public static void town1() throws IOException
	{
		...
		if(choice == 1)
		{
			...
			{	
				...
				player.gold -= 5; //edit the price as you will
		...
		if(choice == 2)
		{
			...
			if(c == 1)
			{
				//make this print out the items you want this town to sell, make sure to check money as well	
